...
plt.plot(vs, yule_roots, 'ro', label="Yule Contacts")
# plt.plot(alphas, yule_r0, 'r-', label="Yule")
plt.plot(vs, yule_finite_outbreak_sizes, 'r-', label="Yule Simulations")
plt.plot(vs, nb_roots, 'ko', label="NB")
# plt.plot(alphas, nb_r0, 'k-', label="NB")
plt.plot(vs, nb_finite_outbreak_sizes, 'k-', label="NB Simulations")
