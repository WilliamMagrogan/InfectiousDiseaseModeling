...
vs = np.linspace(0, 0.5, 10)
buff = np.empty_like(vs)
yule_roots = []
yule_r0 = []
nb_roots = []
nb_r0 = []
...
plt.plot(vs, yule_roots, 'ro', label="Yule Leaky")
# plt.plot(alphas, yule_r0, 'r-', label="Yule")
plt.plot(vs, yule_finite_outbreak_sizes, 'r-', label="Yule Leaky Simulations")
plt.plot(vs, nb_roots, 'ko', label="Yule All-or-Nothing")
# plt.plot(alphas, nb_r0, 'k-', label="NB")
plt.plot(vs, nb_finite_outbreak_sizes, 'k-', label="Yule All-or-Nothing Simulations")
plt.title(r"Minor Outbreak Probability Against Vaccination Fraction")
plt.xlabel(r"$v$, Vaccination Rate")
